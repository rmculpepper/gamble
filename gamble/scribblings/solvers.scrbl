...
@defthing[sample-frame/c contract?]{

A @deftech{sample frame} is a hash with symbol keys. Each key typically has a
vector value, and each element of the vector corresponds to a sample.

@itemlist[

@item{@racket['value] : @racket[vector?] --- Contains the sample
values. Generated by all samplers.}

@item{@racket['log-weight] : @racket[(vectorof flonum?)] --- Contains the
log-weight of each sample. Generated by @racket[importance-sampler] only.}

]

Other sources may support additional keys.
}
