...
random variables, the @racket[gibbs-transition] may be used to do
@wiki["Gibbs_sampling"]{Gibbs sampling} for that variable:
...
@;{
Basic inspection of a model can be done via @racket[model-slice]:
